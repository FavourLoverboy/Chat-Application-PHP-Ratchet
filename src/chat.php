    ...
    class Chat implements MessageComponentInterface {
        ...
        public function onMessage(ConnectionInterface $from, $msg) {
            ...
            if($data['command'] == 'private'){
                ...
                echo $sender_user_data = $user_object->get_user_data_by_id();

                $user_object->setUserId($data['receiver_userid']);

                echo $receiver_user_data = $user_object->get_user_data_by_id();

                $sender_user_name = $sender_user_data['name'];

                $data['datetime'] = $timestamp;

                $receiver_user_connection_id = $receiver_user_data['connection_id'];
